...
void
dispatch::cpu::centerNumericMatrix(NumericMatrix & in_X, NumericMatrix& out){
...
dispatch::cpu::corRcpp(NumericMatrix & X, NumericMatrix& out) {
  ...
  dispatch::cpu::centerNumericMatrix(X, X_centered);
...
dispatch::cpu::covRcpp(NumericMatrix & X,const int norm_type, NumericMatrix& out) {
  ...
  dispatch::cpu::centerNumericMatrix(X, X_centered_temp);
