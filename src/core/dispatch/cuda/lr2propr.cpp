...
#include "kernels/cuda/dispatch/lrm.cuh"
...
NumericMatrix dispatch::cuda::lr2rho(NumericMatrix& lr,  Rcpp::NumericMatrix &out,propr_context context) {
...
NumericMatrix dispatch::cuda::lr2phs(NumericMatrix& lr,  Rcpp::NumericMatrix &out, propr_context context) {
