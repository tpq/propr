...
These figures help us conceptualize high-dimensional data and select a highly proportional module for further analysis. In this example, we have a particular interest in co-cluster 2 because it (1) shows high proportionality in the setting of high individual feature variance, and (2) appears to differentiate the two experimental groups.
