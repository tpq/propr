...
Compositional data are not distributed in Euclidean space, but rather exist in a space known as the Aitchison simplex (Fernandes 2014). The log-ratio transformation transforms relative data from the Aitchison simplex to Euclidean space, allowing us to summarize our data through conventional statistics.
