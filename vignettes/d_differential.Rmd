...
In addition, the `slice` function shows the sample-wise distribution of log-ratio abundances for each pair relative to a reference feature. The `reference` argument can specify any feature by name, but users would likely choose a PAL "hub" as the reference.
